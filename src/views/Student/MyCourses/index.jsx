...
import {studentModule} from "../Module";
    ...
    <>
        <div className="Navbar">
            ...
            <ul class="menu">
                ...
                <li>
                <a className="border-b" href="/studentCourses">My Courses</a>
                </li>
                <li>
                <a href="#">Profile</a>
                </li>
                        ...
                        <Link to='/studentModule'>
                            <div key={index} className="mt-4 rounded-lg bg-white drop-shadow-sm hover:drop-shadow-2xl cursor-pointer" >
                                <div className='' >
                                    ...
                                    <div className="ml-4 py-2 mb-4 w-[130px] text-[12px] bg-[#7fffd4] rounded-md " >
